...
## debug连接
ssh -L 5678:127.0.0.1:5678 huinian@10.130.21.244
...
If the dataset is reorganized as a shared `total/` folder plus split files:

```text
E:\0hn\1data\MapTR\xd\sample\total\*/raster.png
E:\0hn\1data\MapTR\xd\sample\total\*/sample.json
E:\0hn\1data\MapTR\xd\sample\train.txt
E:\0hn\1data\MapTR\xd\sample\val.txt
```

then `train.txt` / `val.txt` should list sample subdirectories relative to
`total/`, one per line.
